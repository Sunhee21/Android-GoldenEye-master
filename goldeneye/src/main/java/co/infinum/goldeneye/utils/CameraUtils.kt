...
internal object CameraUtils {
    ...
    fun calculateScale(activity: Activity, textureView: TextureView, config: CameraConfig): Triple<Float, Float, Float> {
        val previewSize = config.previewSize
...
object GoldenEyeScaleUtils{

    fun getScale(activity: Activity,textureView: TextureView,config: CameraConfig) = CameraUtils.calculateScale(activity, textureView, config)

    fun getMatrix(activity: Activity,textureView: TextureView,config: CameraConfig) = CameraUtils.calculateTextureMatrix(activity, textureView, config)
